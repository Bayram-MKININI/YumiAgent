...
import net.noliaware.yumi_agent.commun.READ_MESSAGE_FRAGMENT_TAG
...
import net.noliaware.yumi_agent.feature_message.presentation.mappers.SentMessageMapper
...
class SentMessagesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.messages_list_layout, container, false).apply {
            ...
            messagesListView?.adapter = MessageAdapter(SentMessageMapper()) { message ->
