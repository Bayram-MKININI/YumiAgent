package net.noliaware.yumi_agent.feature_message.presentation.adapters
...
import net.noliaware.yumi_agent.feature_message.presentation.views.MessagePriorityDropdownItemView
import net.noliaware.yumi_agent.feature_message.presentation.views.MessagePriorityDropdownItemView.MessagePriorityDropdownItemViewAdapter
import net.noliaware.yumi_agent.feature_message.presentation.views.MessagePrioritySelectedItemView
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        getItem(position)?.let { priorityUI ->
            itemView.fillViewWithData(
                MessagePriorityDropdownItemViewAdapter(
